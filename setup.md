...
8. <a href="https://docs.jwplayer.com/platform/docs/vdh-upload-videos" target="_blank">Add videos</a> to your JWP library.
9. <a href="https://docs.jwplayer.com/platform/docs/vdh-playlist-overview" target="_blank">Create a manual or dynamic playlist</a> with the videos that viewers can watch in the Applicaster apps.
10. Copy the manual or dynamic playlist ID to a text file.
11. <a href="https://docs.jwplayer.com/platform/docs/vdh-playlist-overview" target="_blank">Create a search playlist</a>. 
...
14. <a href="https://docs.jwplayer.com/platform/docs/advertising-schedule-ad-breaks" target="_blank">Create an ad schedule.</a>
