...
4. Go in [Zapp]([url](https://zapp.applicaster.com/)) (Applicaster) platform and in the playlist data feed that you want to show ads, add the schedule id: ?adId=<scheduleId>
